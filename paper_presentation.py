...
paperpresentation= Blueprint("paper_presentation",__name__,static_folder="static",template_folder="templates")
...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        newFile = paperpresentation(proof=file.filename, name=st_name, rollno=st_rollno, email=st_email, year=st_year, department=st_department,
